...
-Superscript  [l]  denotes a quantity associated with the  lth layer.
   -Example:  a[L]  is the  Lth  layer activation.
   -W[L]  and  b[L]b[L]  are the  Lth  layer parameters.
...
print("\nInitialising parameters, example for network with 3 inputs, 2 hidden 1 output:")
...
Instructions:
   ...
   -We will store  n[l], the number of units in different layers, in a variable layer_dims. 
       ...
       Thus means W1's shape was (4,2), b1 was (4,1), W2 was (1,4) and b2 was (1,1). Now you will generalize this to  L  layers!
...
print("\nInitialising parameters, example for network with 5 inputs, 4 hidden 3 output:")
print("W1 = " + str(parameters["W1"]))
print("b1 = " + str(parameters["b1"]))
print("W2 = " + str(parameters["W2"]))
print("b2 = " + str(parameters["b2"]))
...
Reminder: The mathematical representation of this unit is Z[l]=W[l]A[l−1]+b[l]. 
...
print("\nTesting Linear forward with test_case:")
print("Z = " + str(Z))
...
print("\nLinear forward with ReLU and sigmoid test_case:")
...
(This is sometimes also called Yhat, i.e., this is  Ŷ.)
Tips:
...
print("\nLinear activations backward sigmoid and ReLU test_case")
