...
I.e., compute both  J(.)J(.)  ("forward propagation") and its derivative with respect to  θθ  ("backward propagation"), in two separate functions.'''
...
print("\nSimple function forward prop, input x = 2 and theta = 4:")
print ("J = " + str(J))

'''
Exercise: Now, implement the backward propagation step (derivative computation) of Figure 1. 
...
For each i in num_parameters:
   ...
   -compute gradapprox = (J+1 - J-1) / (2*ε)'''
...
'''
Note
Gradient Checking is very slow, and at least as we've presented it, doesn't work with dropout. 
